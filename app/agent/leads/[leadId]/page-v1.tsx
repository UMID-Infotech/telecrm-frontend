          ...
          <div className="flex items-start justify-between gap-2 flex-wrap">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {dispCfg && (
                <Badge
                  variant="outline"
                  className={`rounded-full px-2 py-0.5 text-[10px] font-semibold border-0 ${dispCfg.cls}`}
                >
                  ...
                  {(lead.attachments ?? []).length > 0 ? (
                    <div className="space-y-2">
                      {(lead.attachments ?? []).map((att) => (
                        <div
                          key={att.id}
                          className="flex items-center gap-2 p-2 bg-slate-50 border rounded-lg hover:bg-slate-100/80 transition-colors"
                        >
                          <FileText
                            size={16}
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs font-bold text-slate-700 hover:text-blue-600 truncate flex-1"
                          >
                            {att.fileName}
                          </a>
                        </div>
                    ...
                    <div className="space-y-2">
                      {uploadedDocs.map((doc: any, i: number) => (
                        <div
                          key={i}
                          className="flex items-center gap-2 p-2 bg-slate-50 border rounded-lg hover:bg-slate-100/80"
                        >
                          <FileText
                            size={16}
                            className="text-blue-500 shrink-0"
