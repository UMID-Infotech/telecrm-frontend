...
import { BookOpen, CalendarDays, Clock, Search, Tag } from 'lucide-react';
...
function BlogCard({ blog }: { blog: GuideBlog }) {
  return (
    <Link href={`/guides/${blog.id}`} className="group block">
...
export default function GuideBlogsPage() {
  ...
  const fetchBlogs = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/guide-blogs?${params}`, {
