...
export default function CreateLeadPage() {
  ...
  const handleBulkSubmit = async () => {
    // Redirect to bulk create (simple single for now, can extend)
    showToast('Use the single create form above for individual leads', 'default');
  };
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
              ...
              <div className="space-y-1">
                ...
                {field.type === 'BOOLEAN' && (
                  <Select
                    ...
                    onValueChange={(v) => updateField(field.id, { value: v === 'true' })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
      ...
      <div className="flex gap-3">
        <Button variant="outline" onClick={() => router.push('/admin/leads')} className="flex-1">
          Cancel
        </Button>
